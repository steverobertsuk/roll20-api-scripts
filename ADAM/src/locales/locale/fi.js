const TRANSLATION = {
  ...
  errors: {
    ...
    invalidState:
      "Tuntematon tila: <strong>{value}</strong><br><br>Voimassa: {states}",
    missingAction:
    ...
    gridSizeInvalid:
      "Ruudukon koon on oltava kokonaisluku välillä 10–1000 (pikseliä).",
    moveDistanceInvalid:
      "Siirtoetäisyyden on oltava kokonaisluku väliltä 1–20 (neliöt).",
    ...
    profileAssignUsage:
      "Käyttö: <code>!adam --profile assign &lt;profileId&gt;</code>",
    profileUnknown:
    ...
    profileDeleteUsage:
      "Käyttö: <code>!adam --profile poista &lt;profileId&gt;</code>",
    profileDraftUsage:
    ...
    profileNotOwned:
      "Et omista profiilia <strong>{id}</strong>, etkä voi muokata sitä.",
    ...
    invalidSideNumber:
      "Sivunumeron on oltava positiivinen kokonaisluku (1 tai suurempi).",
  ...
  confirm: {
    ...
    stateSet:
      "<strong>{token}</strong>-tilaksi on asetettu <strong>{state}</strong>.",
    actionSet:
    ...
    profileSideSet:
      "Profiili <strong>{id}</strong>: {state}/{animSet} → sivu {number}.",
    profileRenamed:
