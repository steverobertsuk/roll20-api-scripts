const TRANSLATION = {
  ...
  errors: {
    ...
    noTokenSelectedPersistent:
      "Ammiro la tua tenacia. Seleziona prima un token.",
    ...
    invalidState:
      "Stato sconosciuto: <strong>{value}</strong><br><br>Valido: {states}",
    missingAction:
    ...
    autoFaceInvalid:
      "Il valore facciale automatico deve essere: attivato o disattivato.",
    humourInvalid:
      "Il valore dell'umorismo deve essere: attivato o disattivato.",
    ...
    profileAssignUsage:
      "Utilizzo: <code>!adam --profile assegna &lt;profileId&gt;</code>",
    profileUnknown:
    ...
    profileDeleteUsage:
      "Utilizzo: <code>!adam --profile elimina &lt;profileId&gt;</code>",
    profileDraftUsage:
    ...
    profileNotOwned:
      "Non possiedi il profilo <strong>{id}</strong> e non puoi modificarlo.",
    ...
    profileAssignNoControl:
      "Puoi assegnare profili personali solo ai token che controlli.",
    ...
    invalidSideNumber:
      "Il numero laterale deve essere un numero intero positivo (1 o maggiore).",
  ...
  confirm: {
    facing:
      "<strong>{token}</strong> ora affronta <strong>{direction}</strong>.",
    stateSet:
      "Stato <strong>{token}</strong> impostato su <strong>{state}</strong>.",
    actionSet:
      "<strong>{token}</strong> azione: <strong>{action}</strong> → stato: <strong>{state}</strong>.",
    profileAssigned:
      "Profilo <strong>{id}</strong> assegnato a <strong>{token}</strong>.",
    profileRemoved: "Profilo rimosso da <strong>{token}</strong>.",
    profileCreated: "Profilo <strong>{id}</strong> creato.",
    profileSideSet:
      "Profilo <strong>{id}</strong>: {state}/{animSet} → lato {number}.",
    profileRenamed:
      "Profilo <strong>{id}</strong> rinominato in <strong>{name}</strong>.",
    ...
    profileDraftRejected:
      "La bozza del profilo <strong>{id}</strong> è stata rifiutata.",
    macroInstalled:
  ...
  easter: {
    ...
    notGoingAnywhere:
      "ADAMO. ha stabilito che in realtà non andrai da nessuna parte.",
    areWeThereYet: "Siamo già arrivati?",
    sneakSpam:
      "Nessuno ti ha visto.<br>Nessuno ti ha visto.<br>Nessuno ti ha visto.",
