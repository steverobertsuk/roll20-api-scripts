const TRANSLATION = {
  ...
  errors: {
    ...
    invalidAction: 'Bilinmeyen eylem: <strong>{value}</strong><br><br>Bilinen eylemler: {actions}',
    ...
    profileNotOwned: '<strong>{id}</strong> profilinin sahibi değilsiniz ve onu değiştiremezsiniz.',
  ...
  confirm: {
    ...
    profileDraftSubmitted: '<strong>{id}</strong> profiline ilişkin taslak GM onayına gönderildi.',
