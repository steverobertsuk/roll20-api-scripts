const TRANSLATION = {
  ...
  errors: {
    ...
    noTokenSelectedPersistent:
      "Podziwiam Twoją wytrwałość. Najpierw wybierz token.",
    ...
    invalidState:
      "Nieznany stan: <strong>{value}</strong><br><br>Ważny: {states}",
    missingAction:
    ...
    autoFaceInvalid:
      "Wartość automatycznej twarzy musi być: włączona lub wyłączona.",
    ...
    profileAssignUsage:
      "Użycie: <code>!adam --profile przypisz &lt;profileId&gt;</code>",
    profileUnknown:
    ...
    profileDeleteUsage:
      "Użycie: <kod>!adam --profile usuń &lt;profileId&gt;</code>",
    profileDraftUsage:
    ...
    invalidSideNumber:
      "Numer boczny musi być dodatnią liczbą całkowitą (1 lub większą).",
  ...
  confirm: {
    facing:
      "<strong>{token}</strong> stoi teraz twarzą w twarz z <strong>{direction}</strong>.",
    stateSet:
      "Stan <strong>{token}</strong> ustawiony na <strong>{state}</strong>.",
    actionSet:
      "<strong>{token}</strong> akcja: <strong>{action}</strong> → stan: <strong>{state}</strong>.",
    profileAssigned:
      "Profil <strong>{id}</strong> przypisany do <strong>{token}</strong>.",
    profileRemoved: "Profil został usunięty z <strong>{token}</strong>.",
    profileCreated: "Profil <strong>{id}</strong> został utworzony.",
    profileSideSet:
      "Profil <strong>{id}</strong>: {state}/{animSet} → strona {number}.",
    profileRenamed:
    ...
    profileDraftRejected:
      "Wersja robocza profilu <strong>{id}</strong> została odrzucona.",
    macroInstalled:
    ...
    settingsReset:
      "<strong>Ustawienia zostały zresetowane do wartości fabrycznych.</strong>",
  ...
  easter: {
    ...
    notGoingAnywhere:
      "ADAM. ustaliło, że tak naprawdę nigdzie się nie wybierasz.",
    areWeThereYet: "Czy już tam jesteśmy?",
    sneakSpam:
      "Nikt cię nie widział.<br>Nikt cię nie widział.<br>Nikt cię nie widział.",
