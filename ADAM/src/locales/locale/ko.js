const TRANSLATION = {
  ...
  errors: {
    noTokenSelected:
      "선택된 토큰이 없습니다. 먼저 토큰을 선택한 후 방향 버튼을 클릭하세요.",
    noTokenSelectedStill: "아직 선택된 토큰이 없습니다.",
    noTokenSelectedPersistent:
      "나는 당신의 끈기를 존경합니다. 먼저 토큰을 선택하세요.",
    ...
    invalidState:
      "알 수 없는 상태: <strong>{value}</strong><br><br>유효: {states}",
    missingAction:
      "작업을 제공하십시오. 예: 도움말, 주문 시전, 분노, 돌진, 몰래, 유휴, 전투",
    invalidAction:
      "알 수 없는 작업: <strong>{value}</strong><br><br>알려진 작업: {actions}",
    ...
    profileAssignUsage:
      "사용법: <code>!adam --profile 할당 &lt;profileId&gt;</code>",
    profileUnknown:
    ...
    profileDeleteUsage:
      "사용법: <code>!adam --profile 삭제 &lt;profileId&gt;</code>",
    profileDraftUsage:
    ...
    profileAssignNoControl:
      "귀하가 관리하는 토큰에만 개인 프로필을 할당할 수 있습니다.",
  ...
  easter: {
    toTheLeft: "왼쪽으로, 왼쪽으로...",
    notGoingAnywhere:
      "아담. 당신은 실제로 아무데도 가지 않을 것이라고 결정했습니다.",
