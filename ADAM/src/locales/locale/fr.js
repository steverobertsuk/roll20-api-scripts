const TRANSLATION = {
  ...
  errors: {
    ...
    noTokenSelectedPersistent:
      "J'admire votre persévérance. Sélectionnez d'abord un jeton.",
    ...
    invalidState:
      "État inconnu : <strong>{value}</strong><br><br>Valide : {states}",
    missingAction:
    ...
    accessDeniedConfig:
      "Les modifications de configuration sont limitées au GM.",
    accessDeniedProfileAssign:
      "L'attribution de profil est limitée au directeur général.",
    accessDeniedProfileRemove:
      "La suppression du profil est limitée au directeur général.",
    ...
    autoFaceInvalid:
      "La valeur du visage automatique doit être : activée ou désactivée.",
    ...
    profileAssignUsage:
      "Utilisation : <code>!adam --profile assigner &lt;profileId&gt;</code>",
    profileUnknown:
    ...
    profileDeleteUsage:
      "Utilisation : <code>!adam --profile supprimer &lt;profileId&gt;</code>",
    profileDraftUsage:
    ...
    profileApproveGmOnly:
      "Seul le directeur général peut approuver les brouillons de profil.",
    ...
    invalidSideNumber:
      "Le numéro de côté doit être un entier positif (1 ou plus).",
  ...
  confirm: {
    facing:
      "<strong>{token}</strong> fait désormais face à <strong>{direction}</strong>.",
    stateSet:
      "L'état <strong>{token}</strong> est défini sur <strong>{state}</strong>.",
    actionSet:
      "<strong>{token}</strong> action : <strong>{action}</strong> → état : <strong>{state}</strong>.",
    profileAssigned:
      "Profil <strong>{id}</strong> attribué à <strong>{token}</strong>.",
    profileRemoved: "Profil supprimé de <strong>{token}</strong>.",
    profileCreated: "Profil <strong>{id}</strong> créé.",
    profileSideSet:
      "Profil <strong>{id}</strong> : {state}/{animSet} → côté {number}.",
    profileRenamed:
      "Profil <strong>{id}</strong> renommé <strong>{name}</strong>.",
    ...
    profileDraftRejected:
      "Le brouillon du profil <strong>{id}</strong> a été rejeté.",
    macroInstalled:
      "La macro globale '<strong>{name}</strong>' a été créée et est visible par tous les joueurs.",
    configUpdated: "Paramètres mis à jour.",
    settingsReset:
      "<strong>Les paramètres sont réinitialisés aux valeurs par défaut.</strong>",
  ...
  easter: {
    ...
    sneakSpam:
      "Personne ne vous a vu.<br>Personne ne vous a vu.<br>Personne ne vous a vu.",
