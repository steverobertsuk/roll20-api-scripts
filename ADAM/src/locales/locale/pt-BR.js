const TRANSLATION = {
  ...
  errors: {
    ...
    invalidAction: 'Ação desconhecida: <strong>{value}</strong><br><br>Ações conhecidas: {actions}',
  ...
  confirm: {
    ...
    profileDraftSubmitted: 'Rascunho do perfil <strong>{id}</strong> enviado para aprovação do GM.',
