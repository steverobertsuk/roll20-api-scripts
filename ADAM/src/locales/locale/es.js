const TRANSLATION = {
  ...
  errors: {
    ...
    noTokenSelectedPersistent:
      "Admiro tu persistencia. Seleccione un token primero.",
    ...
    invalidState:
      "Estado desconocido: <strong>{value}</strong><br><br>Válido: {states}",
    missingAction:
    ...
    accessDeniedConfig:
      "Los cambios de configuración están restringidos al GM.",
    accessDeniedProfileAssign:
      "La asignación de perfil está restringida al GM.",
    accessDeniedProfileRemove:
      "La eliminación de perfiles está restringida al GM.",
    accessDeniedMacro: "La instalación de macros está restringida al GM.",
    accessDeniedReset:
      "El restablecimiento de la configuración está restringido al GM.",
    unknownCommand:
    ...
    autoFaceInvalid:
      "El valor nominal automático debe estar: activado o desactivado.",
    ...
    profileAssignUsage:
      "Uso: <code>!adam --profile asignar &lt;profileId&gt;</code>",
    profileUnknown:
    ...
    profileDeleteUsage:
      "Uso: <code>!adam --profile eliminar &lt;profileId&gt;</code>",
    profileDraftUsage:
    ...
    profileDeleteGmOnly:
      "La eliminación de este perfil está restringida al GM.",
    ...
    profileAssignNoControl:
      "Solo puedes asignar perfiles personales a los tokens que controlas.",
    ...
    invalidSideNumber:
      "El número lateral debe ser un número entero positivo (1 o mayor).",
  ...
  confirm: {
    facing:
      "<strong>{token}</strong> ahora se enfrenta a <strong>{direction}</strong>.",
    stateSet:
      "Estado <strong>{token}</strong> establecido en <strong>{state}</strong>.",
    actionSet:
      "<strong>{token}</strong> acción: <strong>{action}</strong> → estado: <strong>{state}</strong>.",
    profileAssigned:
      "Perfil <strong>{id}</strong> asignado a <strong>{token}</strong>.",
    ...
    profileRenamed:
      "Perfil <strong>{id}</strong> renombrado a <strong>{name}</strong>.",
    ...
    profileDraftRejected:
      "El borrador del perfil <strong>{id}</strong> ha sido rechazado.",
    macroInstalled:
  ...
  easter: {
    ...
    notGoingAnywhere:
      "ADÁN. ha determinado que en realidad no irás a ninguna parte.",
