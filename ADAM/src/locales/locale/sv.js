const TRANSLATION = {
  ...
  errors: {
    ...
    noTokenSelectedPersistent:
      "Jag beundrar din uthållighet. Välj en token först.",
    ...
    invalidState:
      "Okänd status: <strong>{value}</strong><br><br>Giltigt: {states}",
    missingAction:
      "Ange en åtgärd. Exempel: hjälp, spellcast, rage, dash, smyga, tomgång, strid",
    invalidAction:
      "Okänd åtgärd: <strong>{value}</strong><br><br>Kända åtgärder: {actions}",
    ...
    gridSizeInvalid:
      "Rutnätsstorleken måste vara ett heltal mellan 10 och 1000 (pixlar).",
    moveDistanceInvalid:
      "Flyttavstånd måste vara ett heltal mellan 1 och 20 (kvadrat).",
    ...
    profileAssignUsage:
      "Användning: <code>!adam --profile tilldela &lt;profileId&gt;</code>",
    profileUnknown:
    ...
    profileDeleteUsage:
      "Användning: <code>!adam --profile radera &lt;profileId&gt;</code>",
    profileDraftUsage:
    ...
    profileNotOwned:
      "Du äger inte profilen <strong>{id}</strong> och kan inte ändra den.",
    ...
    invalidSideNumber:
      "Sidnummer måste vara ett positivt heltal (1 eller högre).",
  ...
  confirm: {
    facing:
      "<strong>{token}</strong> står nu inför <strong>{direction}</strong>.",
    stateSet:
      "<strong>{token}</strong> tillstånd inställt på <strong>{state}</strong>.",
    actionSet:
      "<strong>{token}</strong> åtgärd: <strong>{action}</strong> → ange: <strong>{state}</strong>.",
    profileAssigned:
      "Profil <strong>{id}</strong> tilldelad <strong>{token}</strong>.",
    profileRemoved: "Profilen har tagits bort från <strong>{token}</strong>.",
    profileCreated: "Profilen <strong>{id}</strong> har skapats.",
    profileSideSet:
      "Profil <strong>{id}</strong>: {state}/{animSet} → sida {number}.",
    profileRenamed:
      "Profilen <strong>{id}</strong> har bytt namn till <strong>{name}</strong>.",
  ...
  easter: {
    ...
    notGoingAnywhere:
      "A.D.A.M. har bestämt att du faktiskt inte ska någonstans.",
    areWeThereYet: "Är vi där än?",
    sneakSpam:
      "Ingen har sett dig.<br>Ingen har sett dig.<br>Ingen har sett dig.",
