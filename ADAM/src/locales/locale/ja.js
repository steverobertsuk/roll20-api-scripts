const TRANSLATION = {
  ...
  errors: {
    ...
    invalidAction: '不明なアクション: <strong>{value}</strong><br><br>既知のアクション: {actions}',
  ...
  confirm: {
    facing: '<strong>{token}</strong> は <strong>{direction}</strong> と対戦するようになりました。',
  ...
  easter: {
    ...
    sneakSpam: '誰もあなたを見ていません<br>誰もあなたを見ていません<br>誰もあなたを見ていません。',
