const TRANSLATION = {
  ...
  errors: {
    ...
    noTokenSelectedPersistent:
      "Ik bewonder je doorzettingsvermogen. Selecteer eerst een token.",
    ...
    invalidState:
      "Onbekende staat: <strong>{value}</strong><br><br>Geldig: {states}",
    missingAction:
      "Geef een actie op. Voorbeelden: help, spreuk, woede, sprint, sluipen, inactief, vechten",
    invalidAction:
      "Onbekende actie: <strong>{value}</strong><br><br>Bekende acties: {actions}",
    ...
    gridSizeInvalid:
      "De rastergrootte moet een geheel getal tussen 10 en 1000 (pixels) zijn.",
    moveDistanceInvalid:
    ...
    profileAssignUsage:
      "Gebruik: <code>!adam --profile wijs &lt;profileId&gt;</code> toe",
    profileUnknown:
    ...
    profileDeleteUsage:
      "Gebruik: <code>!adam --profile verwijder &lt;profileId&gt;</code>",
    profileDraftUsage:
    ...
    profileDeleteGmOnly:
      "Het verwijderen van dit profiel is beperkt tot de GM.",
    ...
    invalidSideNumber:
      "Zijdenummer moet een positief geheel getal zijn (1 of groter).",
    ...
    macroExists:
      "Er bestaat al een macro met de naam '<strong>{name}</strong>'.",
    simonUnknown:
      "Simon weet niet hoe hij het volgende moet doen: <em>{command}</em><br><br>Probeer: <code>!simon zegt zet n</code>",
  },
  confirm: {
    facing:
      "<strong>{token}</strong> staat nu tegenover <strong>{direction}</strong>.",
    stateSet:
      "<strong>{token}</strong> status ingesteld op <strong>{state}</strong>.",
    actionSet:
      "<strong>{token}</strong> actie: <strong>{action}</strong> → staat: <strong>{state}</strong>.",
    profileAssigned:
      "Profiel <strong>{id}</strong> toegewezen aan <strong>{token}</strong>.",
    profileRemoved: "Profiel verwijderd van <strong>{token}</strong>.",
    profileCreated: "Profiel <strong>{id}</strong> gemaakt.",
    profileSideSet:
      "Profiel <strong>{id}</strong>: {state}/{animSet} → zijkant {number}.",
    profileRenamed:
      "Profiel <strong>{id}</strong> hernoemd naar <strong>{name}</strong>.",
    ...
    settingsReset:
      "<strong>Instellingen teruggezet naar fabrieksinstellingen.</strong>",
  ...
  easter: {
    ...
    notGoingAnywhere:
      "ADAM. heeft vastgesteld dat je eigenlijk nergens heen gaat.",
    areWeThereYet: "Zijn we er al?",
    sneakSpam:
      "Niemand heeft je gezien.<br>Niemand heeft je gezien.<br>Niemand heeft je gezien.",
