const TRANSLATION = {
  ...
  errors: {
    noTokenSelected: 'Токен не выбран. Сначала выберите токен, а затем нажмите кнопку направления.',
    ...
    invalidState: 'Неизвестное состояние: <strong>{value}</strong><br><br>Действительно: {states}',
    missingAction:
    ...
    moveDistanceInvalid: 'Расстояние перемещения должно быть целым числом от 1 до 20 (квадратики).',
